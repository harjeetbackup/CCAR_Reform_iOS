...
extension String {
    ...
    func spellChanged() -> String {
        ...
        name = name.replacingOccurrences(of: "Erev Pesach", with: "Erev_Pesach-Ta'anit_Bechorot_Friday")
        ...
        name = name.replacingOccurrences(of: "Rosh Hashanah 1 II", with: "Rosh_Hashanah_2")
...
// ================================Omer days============================================
        ...
        name = name.replacingOccurrences(of: "Ta\'anit Bechorot", with: "")
...
// ==================================Rosh Chodesh====================================
        ...
        name = name.replacingOccurrences(of: "Rosh Hashana 5778", with: "Rosh_Hashanah_1")

        if name == "Pesach I" && day! == 7 {
            name = name.replacingOccurrences(of: "Pesach I", with: "Pesach_Day_1_Shabbat")
        }else{
            name = name.replacingOccurrences(of: "Pesach I", with: "Pesach_Day_1_Weekday")
        }
        if name == "Pesach VII" && day! == 7 {
            
            name = name.replacingOccurrences(of: "Pesach VII", with: "Pesach_Day_7_Shabbat")
        }else {
            name = name.replacingOccurrences(of: "Pesach VII", with: "Pesach_Day_7")
        }
        if name == "Shavuot I" && day! == 7 {
            
            name = name.replacingOccurrences(of: "Shavuot I", with: "Shavuot_Shabbat")
        }else {
            name = name.replacingOccurrences(of: "Shavuot I", with: "Shavuot")
        }
        if name == "Sukkot I" && day! == 7 {
            
            name = name.replacingOccurrences(of: "Sukkot I", with: "Sukkot_1_Shabbat")
        }else {
